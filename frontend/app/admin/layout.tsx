    ...
    <div className="flex min-h-screen bg-neutral-50">
      ...
      <aside className="w-60 bg-white border-r border-neutral-200 flex flex-col">
        ...
        <div className="flex items-center gap-3 px-5 py-5 border-b border-neutral-100">
          ...
          <div>
            <h1 className="font-semibold text-neutral-900">Logistics Hub</h1>
            <p className="text-xs text-neutral-500">MAIN ADMIN</p>
          </div>
        </div>
      ...
      <div className="flex-1 flex flex-col">
        ...
        <header className="h-16 bg-white border-b border-neutral-200 flex items-center justify-between px-6">
          ...
          <div className="relative w-96">
            ...
            <input
              type="text"
              placeholder="Search tracking ID, recipient, or driver..."
              className="w-full pl-10 pr-4 py-2 bg-neutral-50 border border-neutral-200 rounded-lg text-sm focus:outline-none focus:ring-2 focus:ring-accent-500 focus:border-transparent"
            />
          </div>
          ...
          <div className="flex items-center gap-4">
            {/* Notifications */}
            <button className="relative p-2 text-neutral-500 hover:text-neutral-700 hover:bg-neutral-100 rounded-lg">
              <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <div className="flex items-center gap-3 pl-4 border-l border-neutral-200">
              <div className="text-right">
                <p className="text-sm font-medium text-neutral-900">{user?.username || "Admin"}</p>
                <p className="text-xs text-neutral-500">Hub Manager</p>
              </div>
              <div className="w-10 h-10 bg-accent-100 rounded-full flex items-center justify-center text-accent-600 font-semibold">
